...
type DecodeInstructionBC3CDResult struct {
...
func DecodeInstructionBC3CDEvaluate(
	qm31 *m31.QM31Chip,
	inputPC m31.QM31,
	offset0 m31.QM31,
	offset1 m31.QM31,
	...
	alpha = qm31.Add(alpha, qm31Const(256))
	...
	return DecodeInstructionBC3CDResult{
