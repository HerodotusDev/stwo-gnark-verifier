...
type DecodeInstruction3802DResult struct {
	Offset0MinusBase m31.QM31
	Offset1MinusBase m31.QM31
	Offset2MinusBase m31.QM31
	Op1BaseAP        m31.QM31
	ResAddInactive   m31.QM31
	VerifySum        m31.QM31
	Sum              m31.QM31
}

func DecodeInstruction3802DEvaluate(
	qm31 *m31.QM31Chip,
	inputPC m31.QM31,
	offset0 m31.QM31,
	offset1 m31.QM31,
	...
	// res_add is a bit.
	constraint = qm31.Mul(resAdd, qm31.Sub(one, resAdd))
	constraint = qm31.Mul(constraint, domainVanishInv)
	sum = accumulateConstraint(qm31, sum, randomCoeff, constraint)
	...
	beta = qm31.Add(beta, qm31.Sub(one, resAdd))
	...
	return DecodeInstruction3802DResult{
		...
		Op1BaseAP:        op1BaseAP,
		ResAddInactive:   qm31.Sub(one, resAdd),
		VerifySum:        verifySum,
		Sum:              sum,
	}
}
