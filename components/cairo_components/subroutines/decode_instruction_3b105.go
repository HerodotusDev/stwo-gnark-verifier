...
type DecodeInstruction3B105Result struct {
	Offset2MinusBase m31.QM31
	VerifySum        m31.QM31
	Sum              m31.QM31
}

func DecodeInstruction3B105Evaluate(
	qm31 *m31.QM31Chip,
	inputPC m31.QM31,
	offset2 m31.QM31,
	op1BaseFP m31.QM31,
	...
	beta := qm31.Add(qm31Const(4), qm31.Mul(apUpdateAdd1, qm31Const(32)))
	...
	return DecodeInstruction3B105Result{
